...
**Have a question about the module or coding in general? *Do not create a GitHub issue.* GitHub issues are for feature requests and bug reports. Instead, post in the [Steam group](https://steamcommunity.com/groups/SteamRE/discussions/4/). Such issues may be ignored!**
...
**v1.11.0 or later is required to use this method. v1.12.0 or later is required to use `canTrade`. v3.3.3 or later is required to use `twofactorTime`.**
