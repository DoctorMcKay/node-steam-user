 ...
 * @property {string} [family_group_id]
 */
 ...
 * @property {string} [connection_id_src]
 ...
 * @property {boolean} [on_steam_deck]
 */
 ...
 * @property {boolean} [skip_steamvr_install_dialog]
 * @property {boolean} [always_show_user_chooser]
 * @property {boolean} [show_family_sharing_notifications]
 * @property {boolean} [show_copy_count_in_library]
 ...
 * @property {string} [voice_mic_device_name]
 * @property {number} [voice_mic_input_gain]
 * @property {number} [voice_speaker_output_gain]
 * @property {number} [voice_push_to_talk_setting]
 * @property {Proto_CMsgHotkey} [voice_push_to_talk_key]
 * @property {boolean} [overlay_toolbar_list_view]
 * @property {boolean} [always_use_gamepadui_overlay]
 * @property {string} [overlay_tabs]
 * @property {boolean} [overlay_scale_interface]
 * @property {boolean} [overlay_restore_browser_tabs]
 * @property {boolean} [enable_avif_screenshots]
 ...
 * @property {boolean} [ready_to_play_includes_streaming]
 * @property {boolean} [show_steam_deck_info]
 ...
 * @property {string} [startup_movie_id]
 * @property {string} [startup_movie_local_path]
 * @property {boolean} [startup_movie_shuffle]
 * @property {boolean} [startup_movie_used_for_resume]
 * @property {boolean} [game_notes_enable_spellcheck]
 * @property {number} [screenshot_items_per_row]
 * @property {string} [g_background_path]
 * @property {string} [g_background_max_keep]
 * @property {number} [g_background_time_resolution]
 * @property {Proto_CMsgHotkey} [g_background_mk]
 * @property {Proto_CMsgHotkey} [g_background_tg]
 * @property {boolean} [g_background_a_m]
 * @property {number} [g_background_br]
 * @property {boolean} [g_background_a_s]
 * @property {number} [g_background_mode]
 * @property {number} [g_background_audio]
 * @property {number} [g_max_fps]
 * @property {boolean} [show_timestamps_in_console]
 * @property {boolean} [force_oobe]
 * @property {number} [override_browser_composer_mode]
 * @property {boolean} [cef_remote_debugging_enabled]
 * @property {boolean} [force_deck_perf_tab]
 * @property {boolean} [force_fake_mandatory_update]
 * @property {boolean} [hdr_compat_testing]
 * @property {boolean} [developer_mode_enabled]
 * @property {boolean} [show_advanced_update_channels]
 * @property {number} [gamescope_hdr_visualization]
 * @property {number} [gamescope_app_target_framerate]
 * @property {boolean} [gamescope_enable_app_target_framerate]
 * @property {boolean} [gamescope_disable_framelimit]
 * @property {number} [gamescope_display_refresh_rate]
 * @property {boolean} [gamescope_use_game_refresh_rate_in_steam]
 * @property {boolean} [gamescope_disable_mura_correction]
 * @property {boolean} [gamescope_include_steamui_in_screenshots]
 * @property {boolean} [gamescope_allow_tearing]
 * @property {boolean} [gamescope_composite_debug]
 * @property {boolean} [gamescope_force_composite]
 * @property {string} [gamescope_game_resolution_global]
 * @property {number} [steamos_status_led_brightness]
 * @property {boolean} [steamos_tdp_limit_enabled]
 * @property {number} [steamos_tdp_limit]
 * @property {boolean} [steamos_cec_enabled]
 * @property {boolean} [steamos_cec_wake_on_resume]
 * @property {boolean} [steamos_wifi_debug]
 * @property {boolean} [steamos_wifi_force_wpa_supplicant]
 * @property {number} [steamos_magnifier_scale]
 * @property {boolean} [setting_validation_bool]
 * @property {number} [setting_validation_enum]
 * @property {number} [setting_validation_int32]
 * @property {number} [setting_validation_uint32]
 * @property {string} [setting_validation_uint64]
 * @property {number} [setting_validation_float]
 * @property {string} [setting_validation_string]
 * @property {boolean} [system_bluetooth_enabled]
 */
...
/**
 * @typedef {object} Proto_CMsgClientUnsignedInstallScript
 * @property {number} [app_id]
 * @property {string} [file_name]
 * @property {number} [file_size]
 * @property {boolean} [signature_broken]
 * @property {number} [depot_id]
 * @property {string} [manifest_id]
 * @property {number} [file_flags]
 */
...
/**
 * @typedef {object} Proto_CMsgControllerActionSetMiscSettings
 * @property {string} [cursor_visible_action_set_key]
 * @property {string} [cursor_hidden_action_set_key]
 */

/**
 * @typedef {object} Proto_CMsgControllerConfiguration
 * @property {number} [binding_handle]
 * @property {string} [display_name]
 * @property {string} [description]
 * @property {string} [creator]
 * @property {number} [controller_type]
 * @property {Proto_CMsgGameActionSet[]} sets
 * @property {Proto_CMsgControllerMode[]} modes
 * @property {string} [error_msg]
 * @property {string} [action_block_path]
 * @property {Proto_CMsgControllerActionSetMiscSettings} [misc_action_set_settings]
 * @property {string} [url]
 */

/**
 * @typedef {object} Proto_CMsgControllerInput
 * @property {number} [key]
 * @property {Proto_CMsgControllerInputActivator[]} activators
 * @property {Proto_CMsgControllerInputActivator[]} disabled_activators
 * @property {boolean} [inherited_from_parentset]
 */

/**
 * @typedef {object} Proto_CMsgControllerInputActivator
 * @property {number} [activation]
 * @property {Proto_CMsgControllerInputBinding[]} bindings
 * @property {Proto_CMsgControllerSetting[]} settings
 */

/**
 * @typedef {object} Proto_CMsgControllerInputBinding
 * @property {number} [type]
 * @property {Proto_CMsgControllerInputBinding_KeyBindingData} [key_binding_data]
 * @property {Proto_CMsgControllerInputKeyBinding} [keyboard_key]
 * @property {Proto_CMsgControllerInputMouseButtonBinding} [mouse_button]
 * @property {Proto_CMsgControllerInputGamepadButtonBinding} [gamepad_button]
 * @property {Proto_CMsgControllerInputMouseWheelBinding} [mouse_wheel]
 * @property {Proto_CMsgControllerInputModeShiftBinding} [mode_shift]
 * @property {Proto_CMsgControllerInputGameActionBinding} [game_action]
 * @property {Proto_CMsgControllerInputControllerActionBinding} [controller_action]
 */

/**
 * @typedef {object} Proto_CMsgControllerInputBinding_IconBindingData
...
/**
 * @typedef {object} Proto_CMsgControllerInputBinding_KeyBindingData
 * @property {string} [keys_bound_utf8]
 * @property {string} [friendly_name_utf8]
 * @property {Proto_CMsgControllerInputBinding_IconBindingData} [icon_data]
 */

/**
 * @typedef {object} Proto_CMsgControllerInputControllerActionBinding
 * @property {number} [action]
 * @property {Proto_CMsgControllerInputControllerActionMouseBinding} [mouse]
 * @property {Proto_CMsgControllerInputControllerActionCameraHorizonReset} [camera_horizon_reset]
 * @property {Proto_CMsgControllerInputControllerActionDotsPer360CalibrationSpin} [dots_per_360_calibration_spin]
 * @property {Proto_CMsgControllerInputControllerActionTurnToFaceDirection} [turn_to_face_direction]
 * @property {Proto_CMsgControllerInputControllerActionGameActionSetBinding} [action_set]
 * @property {Proto_CMsgControllerInputControllerActionLEDColorBinding} [led_color]
 * @property {Proto_CMsgControllerInputControllerActionChangePlayerNumberBinding} [change_player_number]
 */

/**
 * @typedef {object} Proto_CMsgControllerInputControllerActionCameraHorizonReset
 * @property {number} [camera_dip_angle]
 * @property {number} [delay_duration]
 * @property {number} [camera_horizon_reset_angle]
 */

/**
 * @typedef {object} Proto_CMsgControllerInputControllerActionChangePlayerNumberBinding
 * @property {number} [player_number]
 */

/**
 * @typedef {object} Proto_CMsgControllerInputControllerActionDotsPer360CalibrationSpin
 * @property {number} [spin_by_amount]
 * @property {number} [spin_duration]
 */

/**
 * @typedef {object} Proto_CMsgControllerInputControllerActionGameActionSetBinding
 * @property {number} [preset_type]
 * @property {string} [action_set_key]
 * @property {boolean} [display]
 * @property {boolean} [beep]
 */

/**
 * @typedef {object} Proto_CMsgControllerInputControllerActionLEDColorBinding
 * @property {number} [setting]
 * @property {number} [brightness]
 * @property {number} [saturation]
 * @property {number} [color_r]
 * @property {number} [color_g]
 * @property {number} [color_b]
 */

/**
 * @typedef {object} Proto_CMsgControllerInputControllerActionMouseBinding
 * @property {number} [x]
 * @property {number} [y]
...
/**
 * @typedef {object} Proto_CMsgControllerInputControllerActionTurnToFaceDirection
 * @property {number} [source_of_direction]
 * @property {number} [turn_duration]
 * @property {boolean} [use_last_direction_if_deadzoned]
 */

/**
 * @typedef {object} Proto_CMsgControllerInputGameActionBinding
 * @property {string} [action_set_key]
 * @property {string} [action_key]
 */

/**
 * @typedef {object} Proto_CMsgControllerInputGamepadButtonBinding
 * @property {number} [button]
 */

/**
 * @typedef {object} Proto_CMsgControllerInputKeyBinding
 * @property {number} [key]
 */

/**
 * @typedef {object} Proto_CMsgControllerInputModeShiftBinding
 * @property {number} [source]
 */

/**
 * @typedef {object} Proto_CMsgControllerInputMouseButtonBinding
 * @property {number} [button]
 */

/**
 * @typedef {object} Proto_CMsgControllerInputMouseWheelBinding
 * @property {number} [button]
 */

/**
 * @typedef {object} Proto_CMsgControllerMode
 * @property {number} [mode]
 * @property {number} [modeid]
 * @property {string} [description]
 * @property {Proto_CMsgControllerInput[]} inputs
 * @property {Proto_CMsgControllerSetting[]} settings
 * @property {string} [friendlyname]
 * @property {number} [source]
 * @property {Proto_CMsgControllerVirtualMenuPreviewInfo} [virtual_menu_info]
 * @property {boolean} [mode_shift]
 */

/**
 * @typedef {object} Proto_CMsgControllerSetting
 * @property {number} [key]
 * @property {number} [int_value]
 * @property {number} [int_min]
 * @property {number} [int_max]
 * @property {number} [int_default]
 * @property {Proto_CMsgControllerSetting} [parentset_setting]
 * @property {string} [long_value]
 */

/**
 * @typedef {object} Proto_CMsgControllerSourceGroup
 * @property {number} [mode]
 * @property {Proto_CMsgControllerInputGameActionBinding} [game_action]
 * @property {Proto_CMsgControllerInput[]} inputs
 * @property {Proto_CMsgControllerSetting[]} settings
 * @property {number} [modeid]
 * @property {boolean} [mode_shift]
 * @property {Proto_CMsgControllerSourceGroup} [mode_shift_source_group]
 */

/**
 * @typedef {object} Proto_CMsgControllerSources
 * @property {number} [key]
 * @property {Proto_CMsgControllerSourceGroup} [active_group]
 */

/**
 * @typedef {object} Proto_CMsgControllerVirtualMenuPreviewInfo
 * @property {number} [source]
 ...
 * @property {number} [menu_style]
 * @property {boolean} [force_on]
 * @property {Proto_CVirtualMenuKey[]} keys
 */
...
/**
 * @typedef {object} Proto_CMsgGameAction
 * @property {string} [key]
 * @property {string} [display_name]
 * @property {number[]} modes
 */

/**
 * @typedef {object} Proto_CMsgGameActionBindingType
 * @property {number} [key]
 * @property {Proto_CMsgGameAction[]} actions
 */

/**
 * @typedef {object} Proto_CMsgGameActionSet
 * @property {string} [key]
 * @property {string} [display_name]
 * @property {boolean} [legacy_set]
 * @property {Proto_CMsgGameActionSet[]} layers
 * @property {Proto_CMsgGameActionBindingType[]} action_binding_types
 * @property {Proto_CMsgControllerSources[]} source_bindings
 */

/**
 * @typedef {object} Proto_CMsgGameServerData
 * @property {string} [steam_id_gs]
 * @property {number} [deprecated_ip]
 * @property {number} [query_port]
 * @property {number} [game_port]
 * @property {number} [sourcetv_port]
 * @property {number} [app_id]
 ...
 * @property {number} [game_data_version]
...
/**
 * @typedef {object} Proto_CMsgGenerateSystemReportReply
...
/**
 * @typedef {object} Proto_CMsgMobileChatFriendMessage
 * @property {string} [steamid_friend]
 * @property {boolean} [local_echo]
 * @property {number} [chat_entry_type]
 * @property {string} [message]
 * @property {number} [current_message_timestamp]
 * @property {number} [current_message_ordinal]
 * @property {number} [previous_message_timestamp]
 * @property {number} [previous_message_ordinal]
 ...
 * @property {number} [session_disposition=0]
 * @property {string} [wg_token__field_39]
 * @property {string} [webui_auth_key]
 * @property {number[]} exclude_client_sessionids
 */
...
/**
 * @typedef {object} Proto_CMsgSetControllerActionSet
 * @property {string} [action_set_key]
 * @property {string} [action_set_layer_key]
 * @property {string} [new_display_name]
 * @property {string} [action_set_to_copy_key]
 */

/**
 * @typedef {object} Proto_CMsgSetControllerInputActivator
 * @property {string} [action_set_key]
 * @property {string} [action_set_layer_key]
 * @property {number} [source_binding_key]
 * @property {boolean} [mode_shift]
 * @property {number} [input_key]
 * @property {number} [activator_index]
 * @property {number} [new_activation]
 * @property {Proto_CMsgControllerSetting} [new_setting]
 * @property {number} [modeid]
 */

/**
 * @typedef {object} Proto_CMsgSetControllerInputActivatorEnabled
 * @property {string} [action_set_key]
 * @property {string} [action_set_layer_key]
 * @property {number} [source_binding_key]
 * @property {boolean} [mode_shift]
...
/**
 * @typedef {object} Proto_CMsgSetControllerInputBinding
 * @property {string} [action_set_key]
 * @property {string} [action_set_layer_key]
 * @property {number} [source_binding_key]
 * @property {boolean} [mode_shift]
 * @property {number} [input_key]
 * @property {number} [activator_index]
 * @property {number} [binding_index]
 * @property {Proto_CMsgControllerInputBinding} [new_binding]
 * @property {number} [source_mode]
 * @property {number} [modeid]
 */

/**
 * @typedef {object} Proto_CMsgSetControllerSourceMode
 * @property {string} [action_set_key]
 * @property {string} [action_set_layer_key]
 * @property {number} [source_binding_key]
 * @property {boolean} [mode_shift]
 * @property {number} [new_mode]
 * @property {Proto_CMsgControllerInputGameActionBinding} [new_game_action]
 * @property {Proto_CMsgControllerSetting} [new_setting]
 * @property {string} [new_name]
 * @property {number} [modeid]
 * @property {boolean} [change_mode]
 * @property {boolean} [new_virtual_menu]
 * @property {boolean} [enable_virtual_menu_support]
 */

/**
 * @typedef {object} Proto_CMsgSetModeShiftButton
 * @property {string} [action_set_key]
 * @property {string} [action_set_layer_key]
 * @property {number} [modeid]
 * @property {number} [source]
 * @property {number} [digital_io]
 */
 ...
 * @property {string} [packets_recv_out_of_order_corrected]
...
/**
 * @typedef {object} Proto_CMsgSwapControllerSourceModes
 * @property {string} [action_set_key_a]
 * @property {string} [action_set_layer_key_a]
 * @property {number} [source_a]
 * @property {string} [action_set_key_b]
 * @property {string} [action_set_layer_key_b]
 * @property {number} [source_b]
 */

/**
 * @typedef {object} Proto_CMsgSwapModeInputBindings
 * @property {string} [action_set_key]
 * @property {string} [action_set_layer_key]
 * @property {number} [source_binding_key]
 * @property {boolean} [mode_shift]
 * @property {number} [modeid]
 * @property {Proto_CMsgSwapModeInputBindings_CModeInputSwap[]} swaps
 */

/**
 * @typedef {object} Proto_CMsgSwapModeInputBindings_CModeInputSwap
 * @property {number} [old_key]
 * @property {number} [new_key]
 */
 ...
 * @property {number[]} supported_refresh_rates
 */
 ...
 * @property {number} [compatibility_mode]
 */
 ...
 * @property {number} [als_lux_primary]
 * @property {number} [als_lux_median]
 * @property {number} [display_backlight_raw]
 ...
 * @property {number} [fan_control_mode]
 * @property {boolean} [is_display_brightness_available]
 * @property {boolean} [is_display_colormanagement_available]
 * @property {number} [display_colorgamut]
 * @property {number} [als_lux_alternate]
 * @property {boolean} [is_display_colortemp_available]
 * @property {number} [display_colortemp]
 * @property {number} [display_colortemp_default]
 * @property {boolean} [display_colortemp_enabled]
 * @property {number} [display_colorgamut_labelset]
 * @property {number} [display_brightness_overdrive_hdr_split]
 */
 ...
 * @property {number[]} gpu_performance_levels_available
 ...
 * @property {number[]} split_scaling_filters_available
 * @property {number[]} split_scaling_scalers_available
 * @property {boolean} [is_hdr_supported]
 * @property {number} [display_refresh_manual_hz_oc_max]
 * @property {boolean} [disable_refresh_rate_management]
 */
 ...
 * @property {number} [system_trace_service_state]
 * @property {number} [graphics_profiling_service_state]
 * @property {number} [perf_overlay_service_state]
 * @property {number} [perf_overlay_level]
 ...
 * @property {boolean} [is_hdr_enabled]
 * @property {number} [hdr_on_sdr_tonemap_operator]
 * @property {boolean} [is_hdr_debug_heatmap_enabled]
 * @property {boolean} [force_hdr_wide_gammut_for_sdr=true]
 * @property {boolean} [allow_experimental_hdr]
 * @property {boolean} [debug_force_hdr_support]
 * @property {boolean} [force_hdr_10pq_output_debug]
 * @property {boolean} [is_display_oc_enabled]
 * @property {boolean} [is_color_management_enabled]
 * @property {number} [sdr_to_hdr_brightness]
 */
 ...
 * @property {number} [gpu_performance_level]
 ...
 * @property {number} [split_scaling_filter]
 * @property {number} [split_scaling_scaler]
 */
 ...
 * @property {boolean} [skip_storage_update]
 */

/**
 * @typedef {object} Proto_CMsgSystemUpdateApplyParams
 * @property {number[]} apply_types
 */
 ...
 * @property {string} [version]
 * @property {string} [auto_message]
 * @property {boolean} [system_restart_pending]
 */
...
/**
 * @typedef {object} Proto_CMsgWebUITransportFailure
 * @property {number} [connect_count]
 */

/**
 * @typedef {object} Proto_CPartnerStoreBrowse_GetItems_Request
 * @property {Proto_CStoreBrowse_GetItems_Request} [request]
 * @property {boolean} [include_unpublished]
 */
...
/**
 * @typedef {object} Proto_CRemoteClient_DeviceDetails
 ...
 * @property {Proto_CRemoteClient_DeviceDetails} [device_details]
 */
...
/**
 * @typedef {object} Proto_CSteamNotification_HideNotification_Notification
 * @property {string[]} notification_ids
 */

/**
 * @typedef {object} Proto_CSteamNotification_MarkNotificationsRead_Notification
 * @property {number} [timestamp]
 * @property {number} [notification_type]
 * @property {string[]} notification_ids
 * @property {boolean} [mark_all_read]
 */

/**
 * @typedef {object} Proto_CSteamNotification_MarkNotificationsViewed_Notification
 * @property {string} [remote_client_id]
 * @property {number} [target_client_type]
 */

/**
 * @typedef {object} Proto_CSteamVR_AudioSettings_ChangeSettings_Request
 * @property {Proto_CSteamVR_AudioSettings_Settings} [settings]
 */

/**
 * @typedef {object} Proto_CSteamVR_AudioSettings_RegisterForSettings_Request
 */

/**
 * @typedef {object} Proto_CSteamVR_AudioSettings_Settings
 * @property {Proto_CSteamVR_AudioSettings_Settings_Channel} [main]
 * @property {Proto_CSteamVR_AudioSettings_Settings_Channel} [audio_mirror]
 * @property {Proto_CSteamVR_AudioSettings_Settings_Channel} [microphone]
 */

/**
 * @typedef {object} Proto_CSteamVR_AudioSettings_Settings_Channel
 * @property {boolean} [available]
...
/**
 * @typedef {object} Proto_CSteamVR_AudioSettings_SettingsChanged_Notification
 * @property {Proto_CSteamVR_AudioSettings_Settings} [settings]
 */

/**
 * @typedef {object} Proto_CSteamVR_Header
 * @property {number} [type]
 * @property {number} [id]
 */

/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_Active_Notification
 */

/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_ConfigureVideo_Request
 * @property {boolean} [send]
 * @property {boolean} [receive]
 */

/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_ConfigureVideo_Response
 */

/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_ExitRoomChat_Request
 * @property {string} [chat_group_id]
 * @property {string} [chat_room_id]
 */

/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_ExitRoomChat_Response
 */

/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_GetAvatarUrl_Request
 * @property {string} [profile_steamid]
 * @property {number} [avatar_type]
 */

/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_GetAvatarUrl_Response
 * @property {string} [profile_avatar_url]
 */

/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_GroupName_Notification
 * @property {string} [name]
 */

/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_Inactive_Notification
 */

/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_InitiateRoomChat_Request
 * @property {string} [chat_group_id]
 * @property {string} [chat_room_id]
 */

/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_InitiateRoomChat_Response
 */

/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_NewGroupChatMsgAdded_Notification
 * @property {string} [chat_group_id]
 * @property {string} [chat_room_id]
 * @property {number} [sender_accountid]
 * @property {number} [timestamp]
...
/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_PerUserGainValue_Notification
 * @property {number} [accountid]
 * @property {boolean} [muted]
...
/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_PerUserVoiceStatus_Notification
 * @property {number} [accountid]
 * @property {boolean} [mic_muted_locally]
 * @property {boolean} [output_muted_locally]
 */

/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_Ready_Notification
 */

/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_SendGroupChatMessage_Request
 * @property {string} [message_with_bbcode]
 */

/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_SendGroupChatMessage_Response
 */

/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_SetDefaultSession_Notification
 * @property {string} [chat_group_id]
 * @property {string} [chat_room_id]
 */

/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_SetPerUserMuting_Request
 * @property {number} [accountid]
 * @property {boolean} [muted]
 */

/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_SetPerUserMuting_Response
 */

/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_SetPerUserVideo_Request
 * @property {number} [accountid]
 * @property {boolean} [receive]
 */

/**
 * @typedef {object} Proto_CSteamVR_VoiceChat_SetPerUserVideo_Response
 */

/**
 * @typedef {object} Proto_CSteamVR_VRGamepadUI_Message
 * @property {Buffer} [header]
 * @property {Buffer} [payload]
 */

/**
 * @typedef {object} Proto_CSteamVR_WebRTC_Active_Notification
 */

/**
 * @typedef {object} Proto_CSteamVR_WebRTC_CloseDataChannel_Request
 * @property {number} [channel_id]
 */

/**
 * @typedef {object} Proto_CSteamVR_WebRTC_CloseDataChannel_Response
 */

/**
 * @typedef {object} Proto_CSteamVR_WebRTC_CreateDataChannel_Request
 * @property {string} [label]
 * @property {boolean} [ordered]
 * @property {number} [max_retransmits]
 * @property {number} [max_packet_life_time]
 */

/**
 * @typedef {object} Proto_CSteamVR_WebRTC_CreateDataChannel_Response
 * @property {number} [channel_id]
 */

/**
 * @typedef {object} Proto_CSteamVR_WebRTC_DataChannel_Close_Notification
 * @property {number} [channel_id]
 */

/**
 * @typedef {object} Proto_CSteamVR_WebRTC_DataChannel_Error_Notification
 * @property {number} [channel_id]
 * @property {string} [reason]
 */

/**
 * @typedef {object} Proto_CSteamVR_WebRTC_DataChannel_Message_Notification
 * @property {number} [channel_id]
 * @property {Buffer} [data]
 */

/**
 * @typedef {object} Proto_CSteamVR_WebRTC_DataChannel_Open_Notification
 * @property {number} [channel_id]
 */

/**
 * @typedef {object} Proto_CSteamVR_WebRTC_Inactive_Notification
 */

/**
 * @typedef {object} Proto_CSteamVR_WebRTC_OnDataChannel_Notification
 * @property {string} [source_steamid]
 * @property {number} [channel_id]
 * @property {string} [label]
 */

/**
 * @typedef {object} Proto_CStore_MigratePartnerLinkTracking_Notification
 * @property {number} [accountid]
 * @property {string} [browserid]
 * @property {number} [backfill_source]
 */

/**
 * @typedef {object} Proto_CStore_ReloadAllReservationPositionMessages_Notification
 */
 ...
 * @property {number} [discount_filter]
 ...
 * @property {number} [desired_resolution_x]
 * @property {number} [desired_resolution_y]
 * @property {number} [desired_framerate_numerator]
 * @property {number} [desired_framerate_denominator]
 * @property {number} [desired_bitrate_kbps=-1]
 ...
 * @property {number} [p2p_scope=0]
 * @property {boolean} [enable_audio_uncompressed=false]
 * @property {Proto_CStreamVideoLimit} [display_limit]
 * @property {Proto_CStreamVideoLimit} [quality_limit]
 * @property {Proto_CStreamVideoLimit} [runtime_limit]
 * @property {Proto_CStreamVideoLimit[]} decoder_limit
 * @property {boolean} [enable_unreliable_fec=false]
 */

/**
 * @typedef {object} Proto_CStreamingServerConfig
 * @property {boolean} [change_desktop_resolution]
 * @property {boolean} [dynamically_adjust_resolution_OBSOLETE]
 * @property {boolean} [enable_capture_nvfbc]
 * @property {boolean} [enable_hardware_encoding_nvidia_OBSOLETE]
 * @property {boolean} [enable_hardware_encoding_amd_OBSOLETE]
 * @property {boolean} [enable_hardware_encoding_intel_OBSOLETE]
 * @property {number} [software_encoding_threads]
 * @property {boolean} [enable_traffic_priority]
 * @property {number} [host_play_audio=0]
 * @property {boolean} [enable_hardware_encoding]
 */

/**
 * @typedef {object} Proto_CStreamVideoLimit
 * @property {number} [codec]
 * @property {Proto_CStreamVideoMode} [mode]
...
/**
 * @typedef {object} Proto_CTransportValidation_AppendToString_Request
 * @property {string[]} append_strings
 */

/**
 * @typedef {object} Proto_CTransportValidation_AppendToString_Response
 * @property {string} [combined_text]
 */

/**
 * @typedef {object} Proto_CVideo_GameRecordingSegmentInfo
 * @property {number} [segment_number]
 * @property {string} [segment_size_bytes]
 * @property {string} [component_name]
 * @property {string} [representation_name]
 */

/**
 * @typedef {object} Proto_CVirtualMenuKey
 ...
 * @property {string} [description]
 * @property {string} [label]
 * @property {string} [glyph_path]
 * @property {string} [icon_filename]
 * @property {string} [color_foreground]
 * @property {string} [color_background]
 * @property {number} [quadrants]
 * @property {number} [binding_type]
 */

/**
 * @typedef {object} Proto_CVRGamepadUI_Message_DashboardActionInvoked_Request
 * @property {number} [action_id]
 * @property {boolean} [toggle_value]
 */

/**
 * @typedef {object} Proto_CVRGamepadUI_Message_DashboardActionInvoked_Response
 */

/**
 * @typedef {object} Proto_CVRGamepadUI_Message_DashboardDesktopWindowClicked_Request
 * @property {number} [window_id]
 */

/**
 * @typedef {object} Proto_CVRGamepadUI_Message_DashboardDesktopWindowClicked_Response
 */

/**
 * @typedef {object} Proto_CVRGamepadUI_Message_DashboardTabClicked_Request
 * @property {number} [tab_id]
 */

/**
 * @typedef {object} Proto_CVRGamepadUI_Message_DashboardTabClicked_Response
 */

/**
 * @typedef {object} Proto_CVRGamepadUI_Message_Error_Response
...
/**
 * @typedef {object} Proto_CVRGamepadUI_Message_Header
 * @property {string} [name]
 * @property {number} [message_id]
 * @property {number} [response_to_message_id]
 * @property {boolean} [is_error_response]
 */

/**
 * @typedef {object} Proto_CVRGamepadUI_Message_HideDashboardPopup_Request
 * @property {number} [dashboard_popup_request_id]
 */

/**
 * @typedef {object} Proto_CVRGamepadUI_Message_HideDashboardPopup_Response
 */

/**
 * @typedef {object} Proto_CVRGamepadUI_Message_RemoteVideoStream_Request
 * @property {number} [source_accountid]
 * @property {string} [video_uniqueid]
 */

/**
 * @typedef {object} Proto_CVRGamepadUI_Message_RemoteVideoStream_Response
 */

/**
 * @typedef {object} Proto_CVRGamepadUI_Message_ShowDashboardPopup_Request
 * @property {number} [dashboard_popup_request_id]
 * @property {string} [popup_overlay_key]
 * @property {string} [parent_overlay_key]
 * @property {Proto_CVRGamepadUI_Message_ShowDashboardPopup_Request_NormalizedPosition} [origin_on_parent]
 * @property {Proto_CVRGamepadUI_Message_ShowDashboardPopup_Request_NormalizedPosition} [origin_on_popup]
 * @property {Proto_CVRGamepadUI_Message_ShowDashboardPopup_Request_Position} [offset]
 * @property {Proto_CVRGamepadUI_Message_ShowDashboardPopup_Request_Rotation} [rotation]
 * @property {boolean} [inherit_parent_pitch]
 * @property {boolean} [inherit_parent_curvature]
 * @property {Proto_CVRGamepadUI_Message_ShowDashboardPopup_Request_Rect} [clip_rect]
 * @property {boolean} [interactive]
 * @property {boolean} [requires_laser]
 * @property {string} [parent_device_path]
 * @property {number} [sort_order]
 * @property {number} [parent_enum]
 */

/**
 * @typedef {object} Proto_CVRGamepadUI_Message_ShowDashboardPopup_Request_NormalizedPosition
 * @property {number} [x]
 * @property {number} [y]
 */

/**
 * @typedef {object} Proto_CVRGamepadUI_Message_ShowDashboardPopup_Request_Position
 * @property {number} [x_pixels]
 * @property {number} [y_pixels]
 * @property {number} [z_pixels]
 * @property {number} [x_meters]
 * @property {number} [y_meters]
 * @property {number} [z_meters]
 */

/**
 * @typedef {object} Proto_CVRGamepadUI_Message_ShowDashboardPopup_Request_Rect
 * @property {number} [u_min]
 * @property {number} [v_min]
 * @property {number} [u_max]
 * @property {number} [v_max]
 */

/**
 * @typedef {object} Proto_CVRGamepadUI_Message_ShowDashboardPopup_Request_Rotation
 * @property {number} [pitch_degrees]
 * @property {number} [yaw_degrees]
 */

/**
 * @typedef {object} Proto_CVRGamepadUI_Message_ShowDashboardPopup_Response
 */

/**
 * @typedef {object} Proto_CVRGamepadUIShared_DashboardAction
 * @property {number} [action_id]
 * @property {boolean} [visible_in_dashboard_bar]
 * @property {boolean} [enabled]
 * @property {string} [display_name]
 * @property {Proto_CVRGamepadUIShared_DashboardActionIcon} [icon]
 * @property {Proto_CVRGamepadUIShared_DashboardActionIcon} [icon_active]
 * @property {number} [invocation=1]
 * @property {boolean} [active]
 * @property {number} [special_invocation]
 * @property {boolean} [visible_in_dashboard_menu]
 */

/**
 * @typedef {object} Proto_CVRGamepadUIShared_DashboardActionIcon
 * @property {number} [enum]
 */

/**
 * @typedef {object} Proto_CVRGamepadUIShared_DashboardTabIcon
 * @property {number} [enum]
 * @property {number} [appid]
...
/**
 * @typedef {object} Proto_CVRGamepadUIShared_PathProperty_DashboardActions
 * @property {Proto_CVRGamepadUIShared_DashboardAction[]} actions
 */

/**
 * @typedef {object} Proto_CVRGamepadUIShared_PathProperty_DashboardTabs
 * @property {Proto_CVRGamepadUIShared_PathProperty_DashboardTabs_Tab[]} tabs
 * @property {number} [selected_tab_id]
 * @property {number} [vr_settings_tab_id]
 * @property {number} [vr_steam_tab_id]
 */

/**
 * @typedef {object} Proto_CVRGamepadUIShared_PathProperty_DashboardTabs_Tab
 * @property {number} [tab_id]
 * @property {boolean} [visible_in_dashboard_bar]
 * @property {string} [display_name]
 * @property {Proto_CVRGamepadUIShared_DashboardTabIcon} [icon]
 * @property {boolean} [visible_in_dashboard_menu]
 */

/**
 * @typedef {object} Proto_CVRGamepadUIShared_PathProperty_DesktopWindows
 * @property {Proto_CVRGamepadUIShared_PathProperty_DesktopWindows_Window[]} windows
 */

/**
 * @typedef {object} Proto_CVRGamepadUIShared_PathProperty_DesktopWindows_Window
 * @property {number} [window_id]
 * @property {number} [hwnd]
 * @property {string} [title]
 * @property {number} [tab_id]
...
/**
 * @typedef {object} Proto_CVRGamepadUIShared_PathProperty_PowerOptions
 * @property {boolean} [can_sleep]
 * @property {boolean} [can_shutdown]
 * @property {boolean} [can_restart_system]
 * @property {boolean} [can_exitvr]
 */
 ...
 * @property {number} [timestamp_free_until]
 */
...
/**
 * @typedef {object} Proto_StoreBrowseFilterFailure
 * @property {number} [filter_failure=0]
 * @property {boolean} [already_owned]
 * @property {boolean} [on_wishlist]
 * @property {boolean} [ignored]
 * @property {boolean} [not_in_users_language]
 * @property {boolean} [not_on_users_platform]
 * @property {boolean} [demo_for_owned_game]
 * @property {boolean} [dlc_for_unowned_game]
 * @property {boolean} [nonpreferred_product_type]
 * @property {number[]} excluded_tagids
 * @property {number[]} excluded_content_descriptorids
 */
 ...
 * @property {boolean} [include_full_description]
 * @property {boolean} [include_included_items]
 * @property {Proto_StoreBrowseItemDataRequest} [included_item_data_request]
 * @property {boolean} [include_assets_without_overrides]
 * @property {boolean} [apply_user_filters]
 * @property {boolean} [include_links]
 */
 ...
 * @property {Proto_StoreItem_IncludedItems} [included_items]
 ...
 * @property {Proto_StoreItem_PurchaseOption} [self_purchase_option]
 ...
 * @property {Proto_StoreItem_Assets} [assets_without_overrides]
 * @property {Proto_StoreBrowseFilterFailure} [user_filter_failure]
 * @property {Proto_StoreItem_Link[]} links
 */
...
/**
 * @typedef {object} Proto_StoreItem_IncludedItems
 * @property {Proto_StoreItem[]} included_apps
 * @property {Proto_StoreItem[]} included_packages
 */

/**
 * @typedef {object} Proto_StoreItem_Link
 ...
 * @property {number} [steam_deck_compat_category]
 */
 ...
 * @property {boolean} [hide_discount_pct_for_compliance=false]
 * @property {number} [included_game_count]
 * @property {string} [lowest_recent_price_in_cents]
 * @property {boolean} [requires_shipping]
 * @property {Proto_StoreItem_PurchaseOption_RecurrenceInfo} [recurrence_info]
 */
...
/**
 * @typedef {object} Proto_StoreItem_PurchaseOption_RecurrenceInfo
 * @property {number} [packageid]
 * @property {number} [billing_agreement_type]
 * @property {number} [renewal_time_unit]
 * @property {number} [renewal_time_period]
 * @property {string} [renewal_price_in_cents]
 * @property {string} [formatted_renewal_price]
 */
 ...
 * @property {number} [eadditionallanguage=-1]
 */
 ...
 * @property {number} [hubcategoryid]
 */

/**
 * @typedef {object} Proto_UserContentDescriptorPreferences
 * @property {Proto_UserContentDescriptorPreferences_ContentDescriptor[]} content_descriptors_to_exclude
 */

/**
 * @typedef {object} Proto_UserContentDescriptorPreferences_ContentDescriptor
...
/**
 * @typedef {object} Proto_SteamNotificationData
 * @property {string} [notification_id]
 * @property {number} [notification_targets]
 * @property {ESteamNotificationType} [notification_type]
 * @property {string} [body_data]
 * @property {boolean} [read]
 * @property {number} [timestamp]
 * @property {boolean} [hidden]
 * @property {number} [expiry]
 * @property {number} [viewed]
 */

/**
 * @typedef {object} Proto_CSteamNotification_NotificationsReceived_Notification
 * @property {Proto_SteamNotificationData[]} notifications
 * @property {number} [pending_gift_count]
 * @property {number} [pending_friend_count]
 * @property {number} [pending_family_invite_count]
 */

/**
 * @typedef {object} Proto_SteamNotificationPreference
 * @property {ESteamNotificationType} [notification_type]
 * @property {number} [notification_targets]
 */

/**
 * @typedef {object} Proto_CSteamNotification_PreferencesUpdated_Notification
 * @property {Proto_SteamNotificationPreference[]} preferences
 */

/**
 * @typedef {object} Proto_SteamNotificationClient
 */
