...
(function(global, factory) { /* global define, require, module */
    ...
    $root.SiteServerUI_Login_Request = (function() {
        ...
        SiteServerUI_Login_Request.encode = function encode(message, writer) {
            ...
            if (message.steamguardcode != null && Object.hasOwnProperty.call(message, "steamguardcode"))
                writer.uint32(/* id 3, wireType 2 =*/26).string(message.steamguardcode);
            if (message.remember_password != null && Object.hasOwnProperty.call(message, "remember_password"))
    ...
    $root.SiteServerUI_Login_Response = (function() {
        ...
        SiteServerUI_Login_Response.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.logon_state != null && Object.hasOwnProperty.call(message, "logon_state"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.logon_state);
            if (message.logon_eresult != null && Object.hasOwnProperty.call(message, "logon_eresult"))
    ...
    $root.SiteServerUI_LoginStatus_Response = (function() {
        ...
        SiteServerUI_LoginStatus_Response.encode = function encode(message, writer) {
            ...
            if (message.username != null && Object.hasOwnProperty.call(message, "username"))
                writer.uint32(/* id 1, wireType 2 =*/10).string(message.username);
            if (message.cached_credentials != null && Object.hasOwnProperty.call(message, "cached_credentials"))
    ...
    $root.SiteServerUI_Logout_Response = (function() {
        ...
        SiteServerUI_Logout_Response.encode = function encode(message, writer) {
            ...
            if (message.logon_state != null && Object.hasOwnProperty.call(message, "logon_state"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.logon_state);
            if (message.logout_eresult != null && Object.hasOwnProperty.call(message, "logout_eresult"))
    ...
    $root.SiteServerUI_Status_Response = (function() {
        ...
        SiteServerUI_Status_Response.encode = function encode(message, writer) {
            ...
            if (message.cache_enabled != null && Object.hasOwnProperty.call(message, "cache_enabled"))
                writer.uint32(/* id 4, wireType 0 =*/32).bool(message.cache_enabled);
            if (message.acct_status != null && Object.hasOwnProperty.call(message, "acct_status"))
    ...
    $root.SiteServerUI_ContentCacheStatus_Response = (function() {
        ...
        SiteServerUI_ContentCacheStatus_Response.encode = function encode(message, writer) {
            ...
            if (message.cache_location != null && Object.hasOwnProperty.call(message, "cache_location"))
                writer.uint32(/* id 3, wireType 2 =*/26).string(message.cache_location);
            if (message.max_size_gb != null && Object.hasOwnProperty.call(message, "max_size_gb"))
                writer.uint32(/* id 4, wireType 0 =*/32).uint32(message.max_size_gb);
            if (message.p2p_enabled != null && Object.hasOwnProperty.call(message, "p2p_enabled"))
                writer.uint32(/* id 5, wireType 0 =*/40).bool(message.p2p_enabled);
            if (message.current_size_gb != null && Object.hasOwnProperty.call(message, "current_size_gb"))
                writer.uint32(/* id 6, wireType 0 =*/48).uint32(message.current_size_gb);
            if (message.current_bw != null && Object.hasOwnProperty.call(message, "current_bw"))
                writer.uint32(/* id 7, wireType 0 =*/56).uint64(message.current_bw);
            if (message.total_bytes_served != null && Object.hasOwnProperty.call(message, "total_bytes_served"))
                writer.uint32(/* id 8, wireType 0 =*/64).uint64(message.total_bytes_served);
            if (message.explicit_ip_address != null && Object.hasOwnProperty.call(message, "explicit_ip_address"))
                writer.uint32(/* id 9, wireType 2 =*/74).string(message.explicit_ip_address);
            if (message.external_process != null && Object.hasOwnProperty.call(message, "external_process"))
