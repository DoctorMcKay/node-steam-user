...
(function(global, factory) { /* global define, require, module */
    ...
    $root.CWorkshop_GetEULAStatus_Request = (function() {
    
        /**
         * Properties of a CWorkshop_GetEULAStatus_Request.
         * @exports ICWorkshop_GetEULAStatus_Request
         * @interface ICWorkshop_GetEULAStatus_Request
         * @property {number|null} [appid] CWorkshop_GetEULAStatus_Request appid
         */
    
        /**
         * Constructs a new CWorkshop_GetEULAStatus_Request.
         * @exports CWorkshop_GetEULAStatus_Request
         * @classdesc Represents a CWorkshop_GetEULAStatus_Request.
         * @implements ICWorkshop_GetEULAStatus_Request
         * @constructor
         * @param {ICWorkshop_GetEULAStatus_Request=} [properties] Properties to set
         */
        function CWorkshop_GetEULAStatus_Request(properties) {
            if (properties)
        ...
        /**
         * CWorkshop_GetEULAStatus_Request appid.
         * @member {number} appid
         * @memberof CWorkshop_GetEULAStatus_Request
         * @instance
         */
        CWorkshop_GetEULAStatus_Request.prototype.appid = 0;
    
        /**
         * Creates a new CWorkshop_GetEULAStatus_Request instance using the specified properties.
         * @function create
         * @memberof CWorkshop_GetEULAStatus_Request
         * @static
         * @param {ICWorkshop_GetEULAStatus_Request=} [properties] Properties to set
         * @returns {CWorkshop_GetEULAStatus_Request} CWorkshop_GetEULAStatus_Request instance
         */
        CWorkshop_GetEULAStatus_Request.create = function create(properties) {
            return new CWorkshop_GetEULAStatus_Request(properties);
        };
    
        /**
         * Encodes the specified CWorkshop_GetEULAStatus_Request message. Does not implicitly {@link CWorkshop_GetEULAStatus_Request.verify|verify} messages.
         * @function encode
         * @memberof CWorkshop_GetEULAStatus_Request
         * @static
         * @param {ICWorkshop_GetEULAStatus_Request} message CWorkshop_GetEULAStatus_Request message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        CWorkshop_GetEULAStatus_Request.encode = function encode(message, writer) {
            if (!writer)
        ...
        /**
         * Encodes the specified CWorkshop_GetEULAStatus_Request message, length delimited. Does not implicitly {@link CWorkshop_GetEULAStatus_Request.verify|verify} messages.
         ...
         * @returns {$protobuf.Writer} Writer
         */
        CWorkshop_GetEULAStatus_Request.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a CWorkshop_GetEULAStatus_Request message from the specified reader or buffer.
         * @function decode
         * @memberof CWorkshop_GetEULAStatus_Request
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {CWorkshop_GetEULAStatus_Request} CWorkshop_GetEULAStatus_Request
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CWorkshop_GetEULAStatus_Request.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.CWorkshop_GetEULAStatus_Request();
        ...
        /**
         * Decodes a CWorkshop_GetEULAStatus_Request message from the specified reader or buffer, length delimited.
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CWorkshop_GetEULAStatus_Request.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
        ...
        /**
         * Verifies a CWorkshop_GetEULAStatus_Request message.
         * @function verify
         * @memberof CWorkshop_GetEULAStatus_Request
         * @static
         ...
         */
        CWorkshop_GetEULAStatus_Request.verify = function verify(message) {
        ...
        /**
         * Creates a CWorkshop_GetEULAStatus_Request message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof CWorkshop_GetEULAStatus_Request
         * @static
         ...
         * @returns {CWorkshop_GetEULAStatus_Request} CWorkshop_GetEULAStatus_Request
         */
        CWorkshop_GetEULAStatus_Request.fromObject = function fromObject(object) {
            if (object instanceof $root.CWorkshop_GetEULAStatus_Request)
                return object;
            var message = new $root.CWorkshop_GetEULAStatus_Request();
        ...
        /**
         * Creates a plain object from a CWorkshop_GetEULAStatus_Request message. Also converts values to other types if specified.
         * @function toObject
         * @memberof CWorkshop_GetEULAStatus_Request
         * @static
         * @param {CWorkshop_GetEULAStatus_Request} message CWorkshop_GetEULAStatus_Request
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        CWorkshop_GetEULAStatus_Request.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults)
        ...
        /**
         * Converts this CWorkshop_GetEULAStatus_Request to JSON.
         * @function toJSON
         * @memberof CWorkshop_GetEULAStatus_Request
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        CWorkshop_GetEULAStatus_Request.prototype.toJSON = function toJSON() {
    ...
    $root.CWorkshop_GetEULAStatus_Response = (function() {
    
        /**
         * Properties of a CWorkshop_GetEULAStatus_Response.
         * @exports ICWorkshop_GetEULAStatus_Response
         * @interface ICWorkshop_GetEULAStatus_Response
         * @property {number|null} [version] CWorkshop_GetEULAStatus_Response version
         * @property {number|null} [timestamp_action] CWorkshop_GetEULAStatus_Response timestamp_action
         * @property {boolean|null} [accepted] CWorkshop_GetEULAStatus_Response accepted
         * @property {boolean|null} [needs_action] CWorkshop_GetEULAStatus_Response needs_action
         */
    
        /**
         * Constructs a new CWorkshop_GetEULAStatus_Response.
         * @exports CWorkshop_GetEULAStatus_Response
         * @classdesc Represents a CWorkshop_GetEULAStatus_Response.
         * @implements ICWorkshop_GetEULAStatus_Response
         * @constructor
         * @param {ICWorkshop_GetEULAStatus_Response=} [properties] Properties to set
         */
        function CWorkshop_GetEULAStatus_Response(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * CWorkshop_GetEULAStatus_Response version.
         * @member {number} version
         * @memberof CWorkshop_GetEULAStatus_Response
         * @instance
         */
        CWorkshop_GetEULAStatus_Response.prototype.version = 0;
    
        /**
         * CWorkshop_GetEULAStatus_Response timestamp_action.
         * @member {number} timestamp_action
         * @memberof CWorkshop_GetEULAStatus_Response
         * @instance
         */
        CWorkshop_GetEULAStatus_Response.prototype.timestamp_action = 0;
    
        /**
         * CWorkshop_GetEULAStatus_Response accepted.
         * @member {boolean} accepted
         * @memberof CWorkshop_GetEULAStatus_Response
         * @instance
         */
        CWorkshop_GetEULAStatus_Response.prototype.accepted = false;
    
        /**
         * CWorkshop_GetEULAStatus_Response needs_action.
         * @member {boolean} needs_action
         * @memberof CWorkshop_GetEULAStatus_Response
         * @instance
         */
        CWorkshop_GetEULAStatus_Response.prototype.needs_action = false;
    
        /**
         * Creates a new CWorkshop_GetEULAStatus_Response instance using the specified properties.
         * @function create
         * @memberof CWorkshop_GetEULAStatus_Response
         * @static
         * @param {ICWorkshop_GetEULAStatus_Response=} [properties] Properties to set
         * @returns {CWorkshop_GetEULAStatus_Response} CWorkshop_GetEULAStatus_Response instance
         */
        CWorkshop_GetEULAStatus_Response.create = function create(properties) {
            return new CWorkshop_GetEULAStatus_Response(properties);
        };
    
        /**
         * Encodes the specified CWorkshop_GetEULAStatus_Response message. Does not implicitly {@link CWorkshop_GetEULAStatus_Response.verify|verify} messages.
         * @function encode
         * @memberof CWorkshop_GetEULAStatus_Response
         * @static
         * @param {ICWorkshop_GetEULAStatus_Response} message CWorkshop_GetEULAStatus_Response message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        CWorkshop_GetEULAStatus_Response.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.version != null && message.hasOwnProperty("version"))
                writer.uint32(/* id 1, wireType 0 =*/8).uint32(message.version);
            if (message.timestamp_action != null && message.hasOwnProperty("timestamp_action"))
                writer.uint32(/* id 2, wireType 0 =*/16).uint32(message.timestamp_action);
            if (message.accepted != null && message.hasOwnProperty("accepted"))
                writer.uint32(/* id 3, wireType 0 =*/24).bool(message.accepted);
            if (message.needs_action != null && message.hasOwnProperty("needs_action"))
                writer.uint32(/* id 4, wireType 0 =*/32).bool(message.needs_action);
            return writer;
        };
    
        /**
         * Encodes the specified CWorkshop_GetEULAStatus_Response message, length delimited. Does not implicitly {@link CWorkshop_GetEULAStatus_Response.verify|verify} messages.
         * @function encodeDelimited
         * @memberof CWorkshop_GetEULAStatus_Response
         * @static
         * @param {ICWorkshop_GetEULAStatus_Response} message CWorkshop_GetEULAStatus_Response message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        CWorkshop_GetEULAStatus_Response.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a CWorkshop_GetEULAStatus_Response message from the specified reader or buffer.
         * @function decode
         * @memberof CWorkshop_GetEULAStatus_Response
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {CWorkshop_GetEULAStatus_Response} CWorkshop_GetEULAStatus_Response
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CWorkshop_GetEULAStatus_Response.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.CWorkshop_GetEULAStatus_Response();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.timestamp_action = reader.uint32();
                    break;
                case 3:
                    message.accepted = reader.bool();
                    break;
                case 4:
                    message.needs_action = reader.bool();
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        /**
         * Decodes a CWorkshop_GetEULAStatus_Response message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof CWorkshop_GetEULAStatus_Response
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CWorkshop_GetEULAStatus_Response.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a CWorkshop_GetEULAStatus_Response message.
         * @function verify
         * @memberof CWorkshop_GetEULAStatus_Response
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        CWorkshop_GetEULAStatus_Response.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.version != null && message.hasOwnProperty("version"))
            ...
            if (message.timestamp_action != null && message.hasOwnProperty("timestamp_action"))
                if (!$util.isInteger(message.timestamp_action))
                    return "timestamp_action: integer expected";
            if (message.accepted != null && message.hasOwnProperty("accepted"))
                if (typeof message.accepted !== "boolean")
                    return "accepted: boolean expected";
            if (message.needs_action != null && message.hasOwnProperty("needs_action"))
                if (typeof message.needs_action !== "boolean")
                    return "needs_action: boolean expected";
            return null;
        };
    
        /**
         * Creates a CWorkshop_GetEULAStatus_Response message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof CWorkshop_GetEULAStatus_Response
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {CWorkshop_GetEULAStatus_Response} CWorkshop_GetEULAStatus_Response
         */
        CWorkshop_GetEULAStatus_Response.fromObject = function fromObject(object) {
            if (object instanceof $root.CWorkshop_GetEULAStatus_Response)
                return object;
            var message = new $root.CWorkshop_GetEULAStatus_Response();
            if (object.version != null)
                message.version = object.version >>> 0;
            if (object.timestamp_action != null)
                message.timestamp_action = object.timestamp_action >>> 0;
            if (object.accepted != null)
                message.accepted = Boolean(object.accepted);
            if (object.needs_action != null)
                message.needs_action = Boolean(object.needs_action);
            return message;
        };
    
        /**
         * Creates a plain object from a CWorkshop_GetEULAStatus_Response message. Also converts values to other types if specified.
         * @function toObject
         * @memberof CWorkshop_GetEULAStatus_Response
         * @static
         * @param {CWorkshop_GetEULAStatus_Response} message CWorkshop_GetEULAStatus_Response
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        CWorkshop_GetEULAStatus_Response.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
                object.version = 0;
                object.timestamp_action = 0;
                object.accepted = false;
                object.needs_action = false;
            }
            if (message.version != null && message.hasOwnProperty("version"))
                object.version = message.version;
            if (message.timestamp_action != null && message.hasOwnProperty("timestamp_action"))
                object.timestamp_action = message.timestamp_action;
            if (message.accepted != null && message.hasOwnProperty("accepted"))
                object.accepted = message.accepted;
            if (message.needs_action != null && message.hasOwnProperty("needs_action"))
                object.needs_action = message.needs_action;
            return object;
        };
    
        /**
         * Converts this CWorkshop_GetEULAStatus_Response to JSON.
         * @function toJSON
         * @memberof CWorkshop_GetEULAStatus_Response
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        CWorkshop_GetEULAStatus_Response.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.Workshop = (function() {
    
        /**
         * Constructs a new Workshop service.
         * @exports Workshop
         * @classdesc Represents a Workshop
         ...
         */
        function Workshop(rpcImpl, requestDelimited, responseDelimited) {
            $protobuf.rpc.Service.call(this, rpcImpl, requestDelimited, responseDelimited);
        }
    
        (Workshop.prototype = Object.create($protobuf.rpc.Service.prototype)).constructor = Workshop;
    
        /**
         * Creates new Workshop service using the specified rpc implementation.
         * @function create
         * @memberof Workshop
         * @static
         * @param {$protobuf.RPCImpl} rpcImpl RPC implementation
         * @param {boolean} [requestDelimited=false] Whether requests are length-delimited
         * @param {boolean} [responseDelimited=false] Whether responses are length-delimited
         * @returns {Workshop} RPC service. Useful where requests and/or responses are streamed.
         */
        Workshop.create = function create(rpcImpl, requestDelimited, responseDelimited) {
            return new this(rpcImpl, requestDelimited, responseDelimited);
        };
    
        /**
         * Callback as used by {@link Workshop#getEULAStatus}.
         * @memberof Workshop
         * @typedef GetEULAStatusCallback
         * @type {function}
         * @param {Error|null} error Error, if any
         * @param {CWorkshop_GetEULAStatus_Response} [response] CWorkshop_GetEULAStatus_Response
         */
         ...
         * @memberof Workshop
         * @instance
         * @param {ICWorkshop_GetEULAStatus_Request} request CWorkshop_GetEULAStatus_Request message or plain object
         * @param {Workshop.GetEULAStatusCallback} callback Node-style callback called with the error, if any, and CWorkshop_GetEULAStatus_Response
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(Workshop.prototype.getEULAStatus = function getEULAStatus(request, callback) {
            return this.rpcCall(getEULAStatus, $root.CWorkshop_GetEULAStatus_Request, $root.CWorkshop_GetEULAStatus_Response, request, callback);
        }, "name", { value: "GetEULAStatus" });
         ...
         * @instance
         * @param {ICWorkshop_GetEULAStatus_Request} request CWorkshop_GetEULAStatus_Request message or plain object
         * @returns {Promise<CWorkshop_GetEULAStatus_Response>} Promise
         * @variation 2
         */
