...
(function(global, factory) { /* global define, require, module */
    ...
    $root.CDataPublisher_ClientUpdateAppJob_Notification = (function() {
    
        /**
         * Properties of a CDataPublisher_ClientUpdateAppJob_Notification.
         * @exports ICDataPublisher_ClientUpdateAppJob_Notification
         * @interface ICDataPublisher_ClientUpdateAppJob_Notification
         * @property {number|null} [app_id] CDataPublisher_ClientUpdateAppJob_Notification app_id
         * @property {Array.<number>|null} [depot_ids] CDataPublisher_ClientUpdateAppJob_Notification depot_ids
         * @property {number|null} [app_state] CDataPublisher_ClientUpdateAppJob_Notification app_state
         * @property {number|null} [job_app_error] CDataPublisher_ClientUpdateAppJob_Notification job_app_error
         * @property {string|null} [error_details] CDataPublisher_ClientUpdateAppJob_Notification error_details
         * @property {number|null} [job_duration] CDataPublisher_ClientUpdateAppJob_Notification job_duration
         * @property {number|null} [files_validation_failed] CDataPublisher_ClientUpdateAppJob_Notification files_validation_failed
         * @property {number|Long|null} [job_bytes_downloaded] CDataPublisher_ClientUpdateAppJob_Notification job_bytes_downloaded
         * @property {number|Long|null} [job_bytes_staged] CDataPublisher_ClientUpdateAppJob_Notification job_bytes_staged
         * @property {number|Long|null} [bytes_comitted] CDataPublisher_ClientUpdateAppJob_Notification bytes_comitted
         * @property {number|null} [start_app_state] CDataPublisher_ClientUpdateAppJob_Notification start_app_state
         * @property {number|Long|null} [stats_machine_id] CDataPublisher_ClientUpdateAppJob_Notification stats_machine_id
         * @property {string|null} [branch_name] CDataPublisher_ClientUpdateAppJob_Notification branch_name
         * @property {number|Long|null} [total_bytes_downloaded] CDataPublisher_ClientUpdateAppJob_Notification total_bytes_downloaded
         * @property {number|Long|null} [total_bytes_staged] CDataPublisher_ClientUpdateAppJob_Notification total_bytes_staged
         * @property {number|Long|null} [total_bytes_restored] CDataPublisher_ClientUpdateAppJob_Notification total_bytes_restored
         * @property {boolean|null} [is_borrowed] CDataPublisher_ClientUpdateAppJob_Notification is_borrowed
         * @property {boolean|null} [is_free_weekend] CDataPublisher_ClientUpdateAppJob_Notification is_free_weekend
         * @property {number|Long|null} [total_bytes_legacy] CDataPublisher_ClientUpdateAppJob_Notification total_bytes_legacy
         * @property {number|Long|null} [total_bytes_patched] CDataPublisher_ClientUpdateAppJob_Notification total_bytes_patched
         * @property {number|Long|null} [total_bytes_saved] CDataPublisher_ClientUpdateAppJob_Notification total_bytes_saved
         * @property {number|null} [cell_id] CDataPublisher_ClientUpdateAppJob_Notification cell_id
         */
    
        /**
         * Constructs a new CDataPublisher_ClientUpdateAppJob_Notification.
         * @exports CDataPublisher_ClientUpdateAppJob_Notification
         * @classdesc Represents a CDataPublisher_ClientUpdateAppJob_Notification.
         * @implements ICDataPublisher_ClientUpdateAppJob_Notification
         * @constructor
         * @param {ICDataPublisher_ClientUpdateAppJob_Notification=} [properties] Properties to set
         */
        function CDataPublisher_ClientUpdateAppJob_Notification(properties) {
            this.depot_ids = [];
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
        ...
        /**
         * CDataPublisher_ClientUpdateAppJob_Notification app_id.
         * @member {number} app_id
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.app_id = 0;
    
        /**
         * CDataPublisher_ClientUpdateAppJob_Notification depot_ids.
         * @member {Array.<number>} depot_ids
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.depot_ids = $util.emptyArray;
    
        /**
         * CDataPublisher_ClientUpdateAppJob_Notification app_state.
         * @member {number} app_state
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.app_state = 0;
    
        /**
         * CDataPublisher_ClientUpdateAppJob_Notification job_app_error.
         * @member {number} job_app_error
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.job_app_error = 0;
         ...
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.error_details = "";
    
        /**
         * CDataPublisher_ClientUpdateAppJob_Notification job_duration.
         * @member {number} job_duration
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.job_duration = 0;
    
        /**
         * CDataPublisher_ClientUpdateAppJob_Notification files_validation_failed.
         * @member {number} files_validation_failed
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.files_validation_failed = 0;
    
        /**
         * CDataPublisher_ClientUpdateAppJob_Notification job_bytes_downloaded.
         * @member {number|Long} job_bytes_downloaded
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.job_bytes_downloaded = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
    
        /**
         * CDataPublisher_ClientUpdateAppJob_Notification job_bytes_staged.
         * @member {number|Long} job_bytes_staged
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.job_bytes_staged = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
    
        /**
         * CDataPublisher_ClientUpdateAppJob_Notification bytes_comitted.
         * @member {number|Long} bytes_comitted
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.bytes_comitted = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
    
        /**
         * CDataPublisher_ClientUpdateAppJob_Notification start_app_state.
         * @member {number} start_app_state
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.start_app_state = 0;
    
        /**
         * CDataPublisher_ClientUpdateAppJob_Notification stats_machine_id.
         * @member {number|Long} stats_machine_id
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.stats_machine_id = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
         ...
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.branch_name = "";
    
        /**
         * CDataPublisher_ClientUpdateAppJob_Notification total_bytes_downloaded.
         * @member {number|Long} total_bytes_downloaded
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.total_bytes_downloaded = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
    
        /**
         * CDataPublisher_ClientUpdateAppJob_Notification total_bytes_staged.
         * @member {number|Long} total_bytes_staged
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.total_bytes_staged = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
    
        /**
         * CDataPublisher_ClientUpdateAppJob_Notification total_bytes_restored.
         * @member {number|Long} total_bytes_restored
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.total_bytes_restored = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
    
        /**
         * CDataPublisher_ClientUpdateAppJob_Notification is_borrowed.
         * @member {boolean} is_borrowed
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.is_borrowed = false;
    
        /**
         * CDataPublisher_ClientUpdateAppJob_Notification is_free_weekend.
         * @member {boolean} is_free_weekend
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.is_free_weekend = false;
    
        /**
         * CDataPublisher_ClientUpdateAppJob_Notification total_bytes_legacy.
         * @member {number|Long} total_bytes_legacy
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.total_bytes_legacy = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
    
        /**
         * CDataPublisher_ClientUpdateAppJob_Notification total_bytes_patched.
         * @member {number|Long} total_bytes_patched
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.total_bytes_patched = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
    
        /**
         * CDataPublisher_ClientUpdateAppJob_Notification total_bytes_saved.
         * @member {number|Long} total_bytes_saved
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.total_bytes_saved = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
    
        /**
         * CDataPublisher_ClientUpdateAppJob_Notification cell_id.
         * @member {number} cell_id
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.cell_id = 0;
    
        /**
         * Creates a new CDataPublisher_ClientUpdateAppJob_Notification instance using the specified properties.
         * @function create
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @static
         * @param {ICDataPublisher_ClientUpdateAppJob_Notification=} [properties] Properties to set
         * @returns {CDataPublisher_ClientUpdateAppJob_Notification} CDataPublisher_ClientUpdateAppJob_Notification instance
         */
        CDataPublisher_ClientUpdateAppJob_Notification.create = function create(properties) {
            return new CDataPublisher_ClientUpdateAppJob_Notification(properties);
        };
    
        /**
         * Encodes the specified CDataPublisher_ClientUpdateAppJob_Notification message. Does not implicitly {@link CDataPublisher_ClientUpdateAppJob_Notification.verify|verify} messages.
         * @function encode
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @static
         * @param {ICDataPublisher_ClientUpdateAppJob_Notification} message CDataPublisher_ClientUpdateAppJob_Notification message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        CDataPublisher_ClientUpdateAppJob_Notification.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
        ...
        /**
         * Encodes the specified CDataPublisher_ClientUpdateAppJob_Notification message, length delimited. Does not implicitly {@link CDataPublisher_ClientUpdateAppJob_Notification.verify|verify} messages.
         * @function encodeDelimited
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @static
         * @param {ICDataPublisher_ClientUpdateAppJob_Notification} message CDataPublisher_ClientUpdateAppJob_Notification message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        CDataPublisher_ClientUpdateAppJob_Notification.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a CDataPublisher_ClientUpdateAppJob_Notification message from the specified reader or buffer.
         * @function decode
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {CDataPublisher_ClientUpdateAppJob_Notification} CDataPublisher_ClientUpdateAppJob_Notification
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CDataPublisher_ClientUpdateAppJob_Notification.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.CDataPublisher_ClientUpdateAppJob_Notification();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a CDataPublisher_ClientUpdateAppJob_Notification message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CDataPublisher_ClientUpdateAppJob_Notification.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a CDataPublisher_ClientUpdateAppJob_Notification message.
         * @function verify
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        CDataPublisher_ClientUpdateAppJob_Notification.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.app_id != null && message.hasOwnProperty("app_id"))
        ...
        /**
         * Creates a CDataPublisher_ClientUpdateAppJob_Notification message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {CDataPublisher_ClientUpdateAppJob_Notification} CDataPublisher_ClientUpdateAppJob_Notification
         */
        CDataPublisher_ClientUpdateAppJob_Notification.fromObject = function fromObject(object) {
            if (object instanceof $root.CDataPublisher_ClientUpdateAppJob_Notification)
                return object;
            var message = new $root.CDataPublisher_ClientUpdateAppJob_Notification();
            if (object.app_id != null)
                message.app_id = object.app_id >>> 0;
            if (object.depot_ids) {
                if (!Array.isArray(object.depot_ids))
                    throw TypeError(".CDataPublisher_ClientUpdateAppJob_Notification.depot_ids: array expected");
                message.depot_ids = [];
        ...
        /**
         * Creates a plain object from a CDataPublisher_ClientUpdateAppJob_Notification message. Also converts values to other types if specified.
         * @function toObject
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @static
         * @param {CDataPublisher_ClientUpdateAppJob_Notification} message CDataPublisher_ClientUpdateAppJob_Notification
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        CDataPublisher_ClientUpdateAppJob_Notification.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
        ...
        /**
         * Converts this CDataPublisher_ClientUpdateAppJob_Notification to JSON.
         * @function toJSON
         * @memberof CDataPublisher_ClientUpdateAppJob_Notification
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        CDataPublisher_ClientUpdateAppJob_Notification.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.DataPublisher = (function() {
        ...
        /**
         * Callback as used by {@link DataPublisher#clientUpdateAppJobReport}.
         * @memberof DataPublisher
         * @typedef ClientUpdateAppJobReportCallback
         * @type {function}
         * @param {Error|null} error Error, if any
         * @param {NoResponse} [response] NoResponse
         */
        ...
        /**
         * Calls ClientUpdateAppJobReport.
         * @function clientUpdateAppJobReport
         * @memberof DataPublisher
         * @instance
         * @param {ICDataPublisher_ClientUpdateAppJob_Notification} request CDataPublisher_ClientUpdateAppJob_Notification message or plain object
         * @param {DataPublisher.ClientUpdateAppJobReportCallback} callback Node-style callback called with the error, if any, and NoResponse
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(DataPublisher.prototype.clientUpdateAppJobReport = function clientUpdateAppJobReport(request, callback) {
            return this.rpcCall(clientUpdateAppJobReport, $root.CDataPublisher_ClientUpdateAppJob_Notification, $root.NoResponse, request, callback);
        }, "name", { value: "ClientUpdateAppJobReport" });
