...
(function(global, factory) { /* global define, require, module */
    ...
    $root.CMsgClientFriendsList = (function() {
         ...
         * @property {Array.<ICMsgClientFriendsList_Friend>|null} [friends] CMsgClientFriendsList friends
         ...
         * @member {Array.<ICMsgClientFriendsList_Friend>} friends
         * @memberof CMsgClientFriendsList
         * @instance
         */
        ...
        CMsgClientFriendsList.encode = function encode(message, writer) {
            ...
            if (message.friends != null && message.friends.length)
                for (var i = 0; i < message.friends.length; ++i)
                    $root.CMsgClientFriendsList_Friend.encode(message.friends[i], writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            ...
            while (reader.pos < end) {
                ...
                case 2:
                    if (!(message.friends && message.friends.length))
                        message.friends = [];
                    message.friends.push($root.CMsgClientFriendsList_Friend.decode(reader, reader.uint32()));
                    break;
                case 3:
        ...
        CMsgClientFriendsList.verify = function verify(message) {
            ...
            if (message.friends != null && message.hasOwnProperty("friends")) {
                ...
                for (var i = 0; i < message.friends.length; ++i) {
                    var error = $root.CMsgClientFriendsList_Friend.verify(message.friends[i]);
                    if (error)
        ...
        CMsgClientFriendsList.fromObject = function fromObject(object) {
            ...
            if (object.friends) {
                ...
                for (var i = 0; i < object.friends.length; ++i) {
                    ...
                    message.friends[i] = $root.CMsgClientFriendsList_Friend.fromObject(object.friends[i]);
                }
            }
        ...
        CMsgClientFriendsList.toObject = function toObject(message, options) {
            ...
            if (message.friends && message.friends.length) {
                ...
                for (var j = 0; j < message.friends.length; ++j)
                    object.friends[j] = $root.CMsgClientFriendsList_Friend.toObject(message.friends[j], options);
            }
            if (message.max_friend_count != null && message.hasOwnProperty("max_friend_count"))
    ...
    $root.CMsgClientFriendsList_Friend = (function() {
    
        /**
         * Properties of a CMsgClientFriendsList_Friend.
         * @exports ICMsgClientFriendsList_Friend
         * @interface ICMsgClientFriendsList_Friend
         * @property {number|Long|null} [ulfriendid] CMsgClientFriendsList_Friend ulfriendid
         * @property {number|null} [efriendrelationship] CMsgClientFriendsList_Friend efriendrelationship
         */
    
        /**
         * Constructs a new CMsgClientFriendsList_Friend.
         * @exports CMsgClientFriendsList_Friend
         * @classdesc Represents a CMsgClientFriendsList_Friend.
         * @implements ICMsgClientFriendsList_Friend
         * @constructor
         * @param {ICMsgClientFriendsList_Friend=} [properties] Properties to set
         */
        function CMsgClientFriendsList_Friend(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * CMsgClientFriendsList_Friend ulfriendid.
         * @member {number|Long} ulfriendid
         * @memberof CMsgClientFriendsList_Friend
         * @instance
         */
        CMsgClientFriendsList_Friend.prototype.ulfriendid = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
    
        /**
         * CMsgClientFriendsList_Friend efriendrelationship.
         * @member {number} efriendrelationship
         * @memberof CMsgClientFriendsList_Friend
         * @instance
         */
        CMsgClientFriendsList_Friend.prototype.efriendrelationship = 0;
    
        /**
         * Creates a new CMsgClientFriendsList_Friend instance using the specified properties.
         * @function create
         * @memberof CMsgClientFriendsList_Friend
         * @static
         * @param {ICMsgClientFriendsList_Friend=} [properties] Properties to set
         * @returns {CMsgClientFriendsList_Friend} CMsgClientFriendsList_Friend instance
         */
        CMsgClientFriendsList_Friend.create = function create(properties) {
            return new CMsgClientFriendsList_Friend(properties);
        };
    
        /**
         * Encodes the specified CMsgClientFriendsList_Friend message. Does not implicitly {@link CMsgClientFriendsList_Friend.verify|verify} messages.
         * @function encode
         * @memberof CMsgClientFriendsList_Friend
         * @static
         * @param {ICMsgClientFriendsList_Friend} message CMsgClientFriendsList_Friend message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        CMsgClientFriendsList_Friend.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
        ...
        /**
         * Encodes the specified CMsgClientFriendsList_Friend message, length delimited. Does not implicitly {@link CMsgClientFriendsList_Friend.verify|verify} messages.
         * @function encodeDelimited
         * @memberof CMsgClientFriendsList_Friend
         * @static
         * @param {ICMsgClientFriendsList_Friend} message CMsgClientFriendsList_Friend message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        CMsgClientFriendsList_Friend.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a CMsgClientFriendsList_Friend message from the specified reader or buffer.
         * @function decode
         * @memberof CMsgClientFriendsList_Friend
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {CMsgClientFriendsList_Friend} CMsgClientFriendsList_Friend
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgClientFriendsList_Friend.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.CMsgClientFriendsList_Friend();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a CMsgClientFriendsList_Friend message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof CMsgClientFriendsList_Friend
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgClientFriendsList_Friend.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a CMsgClientFriendsList_Friend message.
         * @function verify
         * @memberof CMsgClientFriendsList_Friend
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        CMsgClientFriendsList_Friend.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.ulfriendid != null && message.hasOwnProperty("ulfriendid"))
        ...
        /**
         * Creates a CMsgClientFriendsList_Friend message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof CMsgClientFriendsList_Friend
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {CMsgClientFriendsList_Friend} CMsgClientFriendsList_Friend
         */
        CMsgClientFriendsList_Friend.fromObject = function fromObject(object) {
            if (object instanceof $root.CMsgClientFriendsList_Friend)
                return object;
            var message = new $root.CMsgClientFriendsList_Friend();
        ...
        /**
         * Creates a plain object from a CMsgClientFriendsList_Friend message. Also converts values to other types if specified.
         * @function toObject
         * @memberof CMsgClientFriendsList_Friend
         * @static
         * @param {CMsgClientFriendsList_Friend} message CMsgClientFriendsList_Friend
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        CMsgClientFriendsList_Friend.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
        ...
        /**
         * Converts this CMsgClientFriendsList_Friend to JSON.
         * @function toJSON
         * @memberof CMsgClientFriendsList_Friend
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        CMsgClientFriendsList_Friend.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
