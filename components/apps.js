...
SteamUser.prototype.handlers.add(SteamUser.EMsg.ClientLicenseList, function(body) {
...
SteamUser.prototype.handlers.add(SteamUser.EMsg.ClientPlayingSessionState, function(body) {
