...
require('fs').writeFileSync(__dirname + '/../resources/enums.js', "// Auto-generated by generate-enums script on " + (new Date()).toString() + "\n\nvar SteamUser = require('../index.js');\n\n");
			...
			fileContents.split("\n").forEach(function(line) {
				...
				if (!currentEnum) {
					...
					if (line.match(/^};?$/)) {
						...
						require('fs').writeFileSync(__dirname + '/../enums/' + currentEnum.name + '.js', file);
